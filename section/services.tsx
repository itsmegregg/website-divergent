                    ...
                    {cardData.map((card, index) => (
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-br rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] blur-xl"
                                style={{ background: `linear-gradient(45deg, ${card.color.replace('from-', '').replace('to-', '').split(' ').map(c => `var(--${c})`).join(', ')})` }}
                            />
                            ...
                            <motion.div
                                ...
                                variants={cardHover}
                            >
                                <div className={`mb-4 inline-block p-3 rounded-lg bg-gradient-to-br ${card.color} text-white`}>
                                    {card.icon}
                                </div>
