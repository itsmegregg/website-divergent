  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <section className="relative w-full py-32 bg-slate-950 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <MotionH1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight mt-4">
              Who We
              <span className="text-cyan-400 ml-2">
                Are?
              </span>
            </MotionH1>
            <MotionH2 className="text-lg md:text-xl lg:text-2xl text-slate-300 pt-3">
        ...
        >
          {forData.map((data, index) => (
            <MotionDiv
              ...
              className="h-full"
            >
              <div className="border-2 border-slate-200 rounded-xl bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <MotionDiv
      ...
      >
        {/* The icon */}
        <MotionDiv
          className="w-10 h-10 text-cyan-600 mb-2"
          variants={{
      ...
      <MotionDiv
        ...
        initial="hidden"
        animate="visible"
        className="rounded-xl bg-cyan-50 mx-4 md:m-10 overflow-hidden border border-cyan-100"
      >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row w-full px-4 md:px-6 py-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3 tracking-tight text-cyan-600 ">Divergent Technologies?</h1>
          </div>
          <div className="w-full md:flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
              {partnerBenefits.map((data,index)=>(
                <div className="border border-slate-200 rounded-xl p-3 md:p-4 mb-3 w-full max-w-md flex items-center space-x-2 md:space-x-3 bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" key={index}>
                 ...
                 {React.createElement(data.icon)}
                  ...
                  <h2 className="text-base text-slate-600">{data.description}</h2>
                  </div>
                </div>
              ))}
          </div>
      ...
      >
        ...
        <MotionDiv variants={itemVariants} className="relative z-10 flex flex-col items-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4 tracking-tight text-center">
            Our <span className="text-cyan-600">Expertise</span>, Your Advantage
          </h2>
          ...
          >
            <div className="relative aspect-[4/3] w-full overflow-hidden group">
              ...
              <div className="absolute bottom-0 left-0 p-8 w-full">
                ...
                <p className="text-slate-50 text-base leading-relaxed max-w-md">
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    ...
                    <p className="text-slate-100 text-sm">Years Experience</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <p className="text-3xl font-bold text-white">500+</p>
                    <p className="text-slate-100 text-sm">Clients Served</p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {expertiseAdvantages.map((item, idx) => (
                <MotionDiv
                  ...
                  className="h-full"
                >
                  <Card className="h-full border border-slate-200 overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-300">
                    <CardHeader className="pb-2 relative">
                      <div className="absolute top-0 left-0 w-full h-1 bg-cyan-500 transform origin-left transition-transform duration-300 scale-x-0 group-hover:scale-x-100"></div>
                      <CardTitle className="text-xl flex items-center text-slate-800 font-bold">
                        <div className="bg-slate-50 p-3 rounded-xl mr-4 group-hover:bg-cyan-100 transition-colors duration-300">
                          {React.createElement(item.icon, { className: "w-6 h-6 text-cyan-600 flex-shrink-0" })}
                        </div>
                        {item.title}
                      </CardTitle>
                    </CardHeader>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col md:flex-row items-center justify-between">
                    <div className="mb-4 md:mb-0">
                      <h3 className="text-xl font-bold mb-2 text-slate-800">Ready to transform your business?</h3>
                      <p className="text-slate-600">Schedule a consultation with our experts today.</p>
                    </div>
      ...
      >
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-100/30 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4 tracking-tight">
              Empowering the <span className="text-cyan-600">Philippines&apos;</span> Top Malls & Retailers
            </h2>
          ...
          >
            ...
            {trustedMalls.map((mall, idx) => (
              ...
              >
                ...
                >
                  <Card className="h-full border border-slate-200/70 bg-white shadow-sm hover:shadow-xl transition-all duration-300">
                    <CardContent className="p-6 flex flex-col items-center justify-center h-full">
                      ...
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-100 to-blue-100 flex items-center justify-center mb-4">
