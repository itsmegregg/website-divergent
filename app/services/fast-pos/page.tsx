...
export default function FastPOS() {
  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">
                Fast<span className="text-cyan-400 ml-2">POS</span>
              </h1>
      ...
      >
        <h2 className="text-3xl font-bold text-center mb-4 text-slate-900">Built for Quick-Service Excellence</h2>
        <p className="text-lg md:text-xl text-slate-600 text-center max-w-4xl mx-auto">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900">What Makes FastPOS Stand Out</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="bg-cyan-100 text-cyan-600 p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4">
            ...
            <h4 className="font-semibold text-xl mb-2 text-slate-900">Touch Optimized</h4>
            <p className="text-slate-600">Designed for both touchscreen and regular monitors, providing maximum flexibility for your operations.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="font-semibold text-xl mb-2 text-slate-900">Inventory Management</h4>
            <p className="text-slate-600">Track inventory levels in real-time, receive low stock alerts, and manage suppliers efficiently.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="font-semibold text-xl mb-2 text-slate-900">Comprehensive Reporting</h4>
            <p className="text-slate-600">Gain insights into sales, inventory, and staff performance with detailed, customizable reports.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="font-semibold text-xl mb-2 text-slate-900">Smart Kitchen Printing</h4>
            <p className="text-slate-600">Automate order routing to specific kitchen stations, ensuring efficient food preparation and reduced wait times.</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">See FastPOS in Action</h2>
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">Explore our intuitive interface designed for speed and efficiency</p>
        </div>
      ...
      >
        <div className="bg-slate-50 rounded-2xl p-8 shadow-sm border border-slate-200">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-6 text-center text-slate-900">Complete Solution for Quick-Service Retailers</h3>
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-slate-600 text-center mb-6">FastPOS is a cutting-edge point-of-sale system designed for quick-service establishments, ensuring seamless and efficient transactions. With its user-friendly interface and compatibility with both touch-screen and regular monitors, FastPOS streamlines ordering and payment processes, allowing customers to place and pay for their orders swiftly at the cashier.</p>
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-slate-600 text-center">FastPOS goes beyond just processing payments—it offers inventory management, sales tracking, flexible pricing options, and security features to enhance operational efficiency. It even integrates a cloud-based Report Management System (RMS), providing real-time insights into sales performance, discounts, payment types, and peak business hours, accessible anytime and anywhere. Whether optimizing order fulfillment or ensuring smooth cashier operations, FastPOS is the ultimate solution for businesses aiming to elevate their speed, convenience, and service quality.</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900">See FastPOS in Action</h2>
        </div>
      ...
      <section className="bg-slate-950 py-20 relative overflow-hidden my-16">
        <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-cyan-500/20 rounded-full blur-3xl" />
        <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-blue-500/20 rounded-full blur-3xl" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
